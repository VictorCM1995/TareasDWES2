...
<html lang="en">
  ...
  <body>
    ...
    <script src="{{url('/assets/bootstrap/js/bootstrap.min.js') }}" integrity="sha384-p34f1UUtsS3wqzfto5wAAmdvj+osOnFyQFpp4Ua3gs/ZVWx6oOypYoCJhGGScy+8" crossorigin="anonymous"></script>
